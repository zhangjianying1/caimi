...
/******/ 			script.src = __webpack_require__.p + "js/" + {"1":"cd46"}[chunkId] + ".chunk.js";
...
/***/ function(module, exports, __webpack_require__) {
	...
	var store = creatrStore(_reducer2.default);

	(0, _reactDom.render)(_react2.default.createElement(
	  _reactRedux.Provider,
	  { store: store },
	  _react2.default.createElement(_reactRouter.Router, { history: _reactRouter.hashHistory, routes: toures })
...
/***/ function(module, exports, __webpack_require__) {
	...
	var isHostObject = __webpack_require__(221),
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = {
	    component: __webpack_require__(241).default,
	    childRoutes: [{
	        path: '/exchagne',
	        getComponents: function getComponents(location, callback) {
	            __webpack_require__.e/* nsure */(1, function (require) {
	                callback(null, __webpack_require__(249).default);
	            });
	        }
	    }]
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _action = __webpack_require__(242);

	var _Loading = __webpack_require__(243);

	var _Loading2 = _interopRequireDefault(_Loading);

	var _Confirm = __webpack_require__(244);
	...
	var App = function (_React$Component) {
	    ...
	    _createClass(App, [{
	        ...
	        value: function showConfirm() {
	            ...
	            disatch((0, _action.confirm)({ bBtn: true }));
	        }
	    }, {
	        key: 'componentDidMount',
	        value: function componentDidMount(child) {
	            return _react2.default.cloneElement(child, { showConfirm: this.showConfirm });
	        }
	    }, {
	        key: 'render',
	        value: function render() {
	            ...
	            return _react2.default.createElement(
	                ...
	                _react2.default.children.map(function (child) {
	                    return _this2.componentDidMount(child);
	                }),
	...
	var Confirm = function (_React$Component) {
	    ...
	    _createClass(Confirm, [{
	        ...
	        value: function render() {
	            ...
	            return _react2.default.createElement(
	                'div',
	                { className: 'dialog', style: { display: confirmData.bBtn ? 'block' : 'none' }, onClick: function onClick() {
	                        return _this2.close();
	                    } },
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        ...
	                        _react2.default.createElement(
	                            'a',
	                            { href: 'javascript:;', className: 'react', onClick: function onClick(e) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "/* view */\n.dialog {\n  width: 100%;\n  height: 100%;\n  position: absolute;\n  left: 0;\n  top: 0;\n  right: 0;\n  botton: 0;\n  z-index: 9;\n  background: rgba(0, 0, 0, 0.6); }\n  .dialog > div {\n    position: absolute;\n    left: 50%;\n    top: 50%;\n    -webkit-transform: translate(-50%, -50%);\n    transform: translate(-50%, -50%);\n    background: #fff;\n    overflow: hidden; }\n\n.dialog-confirm, .dialog-alert {\n  width: 2.6rem;\n  border-radius: .04rem; }\n  .dialog-confirm header, .dialog-alert header {\n    line-height: .36rem;\n    font-size: .15rem;\n    color: #fff;\n    background: #f25a52;\n    text-align: center; }\n  .dialog-confirm .msg, .dialog-alert .msg {\n    min-height: .89rem;\n    padding: .3rem 0 .17rem;\n    font-size: .14rem;\n    text-align: center; }\n  .dialog-confirm footer, .dialog-alert footer {\n    display: -webkit-box;\n    display: box;\n    border-top: 1px solid #eee;\n    -webkit-box-align: center;\n    box-align: center; }\n    .dialog-confirm footer a, .dialog-alert footer a {\n      display: block;\n      -webkit-box-flex: 1;\n      box-flex: 1;\n      line-height: .4rem;\n      font-size: .17rem;\n      color: #f25a52;\n      text-align: center; }\n      .dialog-confirm footer a:first-child, .dialog-alert footer a:first-child {\n        border-right: 1px solid #eee; }\n", ""]);

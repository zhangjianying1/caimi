...
/***/ function(module, exports, __webpack_require__) {
	...
	var _historyLottery = __webpack_require__(324);

	var _historyLottery2 = _interopRequireDefault(_historyLottery);
	    ...
	    _createClass(HistoryLottery, [{
	        ...
	        value: function loadFN(elem, reset) {
	            ...
	            if (bBtn) {
	                ...
	                console.log('----------------------');
	                this.setState({
	                    historyLotteryList: [1],
	                    page: 0
	                });
	                console.log(this.props);
	                _superagent2.default.get('baidu.com').query({ lotteryId: this.props.params.lotteryId, issue: this.props.params.issue, page: this.state.page }).then(function (res) {
	                    console.log('---------------------------------------');
	                    // 有返回信息
	                    res = {
	                        ok: true,
	            ...
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        ...
	                        this.state.historyLotteryList.length > 0 ? _react2.default.createElement('historyLottery', { historyLotteryList: this.state.historyLotteryList }) : null,
	...
	/* REACT HOT LOADER */ }).call(this); } finally { if (true) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = __webpack_require__(241); if (makeExportsHot(module, __webpack_require__(68))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "HistoryLottery.js" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(4)(module)))

...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Comment = __webpack_require__(332);
	            ...
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        ...
	                        shareLotteryDetailList.map(function (val, index) {
	                                    ...
	                                    _react2.default.createElement(
	                                        ...
	                                        val.shareImg.map(function (image, index) {
	                                            return _react2.default.createElement('img', { key: index, id: image, onClick: function onClick(e) {
	                                                    return _this6.clickImg(e, val.shareId, index);
	                                                }, className: 'img' });
	                                        })
	                                    )
	                                ),
	                                    ...
	                                    _react2.default.createElement(
	                                        ...
	                                        _react2.default.createElement(
	                                            ...
	                                            { onClick: function onClick(e) {
	                                                    return _this6.clickPraise(e, val.shareId);
	                                                } },
	                                        ...
	                                        _react2.default.createElement(
	                                            'strong',
	                                            { onClick: function onClick(e) {
	                                                    return _this6.clickComment(e, val.shareId);
	                                                } },
	                        ...
	                        _react2.default.createElement(_Comment2.default, { lotteryId: this.props.params.lotteryId, issue: this.props.params.issue, shareId: this.props.params.shareId, replyHandle: function replyHandle(comment) {
	                                return _this6.replyHandle(comment);
	                            },
	                            userName: shareLotteryDetailList[0] && shareLotteryDetailList[0].userName, sendNotice: this.state.sendNotice, commentData: this.state.commentData })
	                    )
	                ),
	                _react2.default.createElement(
	                    'form',
	...
	/* REACT HOT LOADER */ }).call(this); } finally { if (true) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = __webpack_require__(241); if (makeExportsHot(module, __webpack_require__(68))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "ShareLotteryDetail.js" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(4)(module)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Commont = function (_React$Component) {
	    ...
	    _createClass(Commont, [{
	        ...
	        value: function shouldComponentUpdate(nextProps, nextState) {
	            ...
	            if (nextProps.lotteryId && nextState.comment.length) {
	                return true;
	            } else {
	                return false;
	            }
	        ...
	        value: function componentWillReceiveProps(nextProps) {
	            ...
	            // 如果回复成功把回复的内容合并到 comment
	            if (nextProps.commentData.length) {

	                this.setState({
	                    comment: this.state.comment.concat(nextProps.commentData)
	                });
	            }
	        }
	    }, {
	                    ...
	                    if (res.ok) {
	                        ...
	                        if (body.code === '0000') {
	                            ...
	                            if (_this2.state.page == 3) {
	                                ...
	                                _this2.setState({
	                                    comment: _this2.state.comment.concat(body.result.arrayList),
	        ...
	        key: 'replyHandle',
	        value: function replyHandle(comment) {
	            if (this.props.replyHandle) {
	                this.props.replyHandle(comment);
	            }
	        }
	    }, {
	        key: 'render',
	        value: function render() {
	            ...
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    'ul',
	                    null,
	                    comment.map(function (val, index) {
	                        return _react2.default.createElement(
	                            'li',
	                            { key: index, onClick: function onClick() {
	                                    return _this3.replyHandle(val);
	                                } },
	                            _react2.default.createElement(
	                                'div',
	                                { className: 'comd-cont share-lottery-comd share-detail-user' },
	                                ...
	                                _react2.default.createElement(
	                                    ...
	                                    _react2.default.createElement(
	                                        ...
	                                        _react2.default.createElement(
	                                            ...
	                                            val.userName,
	                                            val.userName == _this3.props.userName ? _react2.default.createElement(
	                                                'span',
	...
	/* REACT HOT LOADER */ }).call(this); } finally { if (true) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = __webpack_require__(241); if (makeExportsHot(module, __webpack_require__(68))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "Comment.js" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(4)(module)))

...
/***/ function(module, exports, __webpack_require__) {
	...
	var NewJackpot = function (_React$Component) {
	    _inherits(NewJackpot, _React$Component);

	    function NewJackpot(props) {
	        _classCallCheck(this, NewJackpot);

	        var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(NewJackpot).call(this, props));
	    ...
	    _createClass(NewJackpot, [{
	        ...
	        value: function render() {
	            ...
	            return _react2.default.createElement(
	                'div',
	                { className: 'new-jackpot' },
	                _react2.default.createElement(_Header2.default, { title: '最新中奖' }),
	                _react2.default.createElement(
	                    'div',
	                    { className: 'body' },
	                    _react2.default.createElement(
	                        ...
	                        _react2.default.createElement(_Jackpot2.default, { url: '#/gladController/newjackpot', args: this.state.args })
	                    )
	                )
	            );
	        }
	...
	exports.default = (0, _reactRedux.connect)()(NewJackpot);

	/* REACT HOT LOADER */ }).call(this); } finally { if (true) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = __webpack_require__(241); if (makeExportsHot(module, __webpack_require__(68))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "NewJackpot.js" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(4)(module)))

...
/***/ function(module, exports, __webpack_require__) {
	    ...
	    _createClass(Address, [{
	        ...
	        value: function loadFN(elem, reset) {
	            ...
	            if (bBtn) {
	                ...
	                _superagent2.default.get('#/userController/address').set('Accept', 'application/json').query({ page: this.state.page, userCode: _Auth2.default.getUserCode() }).then(function (res) {
	                    // 有返回信息
	                    res = {
	                        ok: true,
	                        body: {
	                        ...
	                        if (body.code === '0000') {
	                            ...
	                            if (_this2.state.page == 3) {
	                                ...
	                                (function () {
	                                    ...
	                                    var temp = _this2.state.address.concat(body.result.arrayList),
	                                    ...
	                                    // 存晒单数据
	                                    dispatch((0, _action.address)(_this2.state.address));
	                                })();
	                            }
	                            // 打开开关变量
	                            bBtn = true;
	        ...
	        value: function render() {
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(_Header2.default, { title: '我的收货地址' }),
	                _react2.default.createElement(
	                    'div',
	                    { className: 'body' },
	                    this.state.address.length > 0 ? _react2.default.createElement(
	                        'ul',
	                        { className: 'address-list' },
	                        this.state.address.map(function (val, index) {
	                            return _react2.default.createElement(
	                                'li',
	                                { key: index, className: val.default == 0 ? 'active' : null },
	                                _react2.default.createElement(
	                                    _reactRouter.Link,
	                                    { to: 'addressdetail/' + val.addressId },
	                                    val.default == 0 ? _react2.default.createElement(
	                                        'p',
	                                        { className: 'address-default' },
	                                        '默认地址：',
	                                        _react2.default.createElement('span', { className: 'icon icon-defalt-address' })
	                                    ) : null,
	                                    _react2.default.createElement(
	                                        'div',
	                                        { className: 'a-cont' },
	                ...
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        _reactRouter.Link,
	                        { to: 'addaddress/0', className: 'btn btn-small-primary' },
	                        '添加新地址'
	                    )
	                )
	            );
	...
	exports.default = (0, _reactRedux.connect)()(Address);

	/* REACT HOT LOADER */ }).call(this); } finally { if (true) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = __webpack_require__(241); if (makeExportsHot(module, __webpack_require__(68))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "Address.js" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(4)(module)))

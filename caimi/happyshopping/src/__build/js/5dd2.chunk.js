...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Scrollload = __webpack_require__(341);

	var _Scrollload2 = _interopRequireDefault(_Scrollload);

	var _action = __webpack_require__(247);

	var _Area = __webpack_require__(346);

	var _Area2 = _interopRequireDefault(_Area);

	var _Input = __webpack_require__(347);
	...
	var AddAddress = function (_React$Component) {
	    ...
	    _createClass(AddAddress, [{
	            ...
	            if (params.addressId != 0) {
	                ...
	                if (addressData) {
	                    ...
	                    addressData.map(function (val) {
	                        if (val.addressId == _this2.props.params.addressId) _address = val;
	                    });
	                    this.setState({
	                        name: _address.name,
	                        mobile: _address.mobile,
	                        postCode: _address.postCode,
	                        area: _address.province + ' ' + _address.city + ' ' + _address.area,
	                        addressDetail: _address.addressDetail
	                    });
	                } else {

	                    dispatch((0, _action.loading)(true));
	                    _superagent2.default.get('#/glodController/address').set('Accept', 'application/json').query({ addressId: params.addressId }).then(function (res) {
	                        // 有返回信息
	                        res = {
	                            ok: true,
	                            body: {
	                        ...
	                        if (res.ok) {
	                            ...
	                            if (body.code === '0000') {
	                                var _address2 = body.result.arrayList[0];

	                                _this2.setState({
	                                    name: _address2.name,
	                                    mobile: _address2.mobile,
	                                    postCode: _address2.postCode,
	                                    area: _address2.province + ' ' + _address2.city + ' ' + _address2.area,
	                                    addressDetail: _address2.addressDetail
	                                });
	                            }
	        ...
	        key: 'inputHandle',
	        value: function inputHandle(name, val) {
	            this.state[name] = val;
	        }
	    }, {
	        key: 'subFN',
	        value: function subFN() {
	            ...
	            var addressDetail = this.state.addressDetail;

	            if (!name) {
	                dispatch((0, _action.error)('收货人姓名不能为空'));
	            } else if (!mobile) {
	                dispatch((0, _action.error)('收货人手机号码不能为空'));
	            } else if (!area || !addressDetail) {
	                dispatch((0, _action.error)('收货人地址不能为空'));
	            } else if (bBtn) {
	                bBtn = false;
	                dispatch((0, _action.loading)(true));
	                _superagent2.default.get('#/userController/putaddress').set('Accept', 'application/json').query({ name: name, mobile: mobile, postCode: postCode, area: area, addressDetail: addressDetail }).then(function (res) {
	                    // 有返回信息
	                    res = {
	                        ok: true,
	                        body: {
	                    ...
	                    if (res.ok) {
	                        ...
	                        if (body.code === '0000') {
	                            _this3.props.history.pushState(null, '/address');
	                        }
	                        bBtn = true;
	                        dispatch((0, _action.loading)(false));
	                    }
	        ...
	        value: function render() {
	            ...
	            var postCode = _state.postCode;
	            var area = _state.area;
	            var addressDetail = _state.addressDetail;
	            ...
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        'span',
	                        { className: 'header-control', onClick: function onClick() {
	                                return _this4.subFN();
	                            } },
	                        '保存'
	                    )
	                ...
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        ...
	                        _react2.default.createElement(
	                            ...
	                            _react2.default.createElement(_Input2.default, { name: 'name', val: name, placeholder: '请输入姓名', inputHandle: function inputHandle(name, val) {
	                                    return _this4.inputHandle(name, val);
	                                } })
	                        ),
	                        _react2.default.createElement(
	                            'div',
	                            ...
	                            _react2.default.createElement(_Input2.default, { name: 'mobile', placeholder: '请输入手机号码', val: mobile, inputHandle: function inputHandle(name, val) {
	                                    return _this4.inputHandle(name, val);
	                                } })
	                        )
	                    ),
	                    _react2.default.createElement(
	                        ...
	                        _react2.default.createElement(
	                            ...
	                            _react2.default.createElement(_Input2.default, { type: 'tel', name: 'postCode', placeholder: '请输入邮编', val: postCode, inputHandle: function inputHandle(name, val) {
	                                    return _this4.inputHandle(name, val);
	                                } })
	                        ),
	                        _react2.default.createElement(
	                            'div',
	                            { className: 'input-box go-to' },
	                            _react2.default.createElement(
	                                'label',
	                                null,
	                                '省、市、区：'
	                            ),
	                            _react2.default.createElement(_Area2.default, { name: 'area', placeholder: '请选择', val: area, inputHandle: function inputHandle(name, val) {
	                                    return _this4.inputHandle(name, val);
	                                } })
	                        )
	                    ),
	                    _react2.default.createElement(
	                        ...
	                        _react2.default.createElement(
	                            ...
	                            _react2.default.createElement(_Input2.default, { tagName: 'textarea', name: 'addressDetail', placeholder: '请输入详细地址（社区、街道、门牌号）', val: addressDetail, inputHandle: function inputHandle(name, val) {
	                                    return _this4.inputHandle(name, val);
	                                } })
	                        )
	                    )
	...
	/* REACT HOT LOADER */ }).call(this); } finally { if (true) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = __webpack_require__(241); if (makeExportsHot(module, __webpack_require__(68))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "AddAddress.js" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(4)(module)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Area = function (_React$Component) {
	    ...
	    function Area(props) {
	        ...
	        var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(Area).call(this, props));
	    ...
	    _createClass(Area, [{
	        ...
	        value: function changeHandle(e) {
	            var target = e.target;
	            if (this.props.inputHandle) {
	                this.props.inputHandle(this.props.name, target.value);
	            }
	        }
	    }, {
	        key: 'render',
	        value: function render() {
	            ...
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement('input', { id: 'demo1', placeholder: this.props.val, type: 'text', readOnly: true, onBlur: function onBlur(e) {
	...
	/* REACT HOT LOADER */ }).call(this); } finally { if (true) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = __webpack_require__(241); if (makeExportsHot(module, __webpack_require__(68))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "Area.js" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(4)(module)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Input = function (_React$Component) {
	    ...
	    _createClass(Input, [{
	        ...
	        key: 'changeHandle',
	        value: function changeHandle(val) {
	            var msg = '',
	                props = this.props;
	            ...
	            if (props.pattern) {
	                var pattern = new RegExp(props.pattern, 'g');
	        ...
	        value: function render() {
	            ...
	            return _react2.default.createElement(
	                'div',
	                { className: 'form-control' },
	                this.props.tagName == 'textarea' ? _react2.default.createElement(
	                    'div',
	                    { className: 'a-detail' },
	                    _react2.default.createElement('textarea', { onChange: function onChange(e) {
	                            return _this2.inputChange(e);
	                        }, type: this.props.type, name: this.state.input.name,
	                        value: this.state.input.val, placeholder: this.props.placeholder, autoComplete: 'off', required: true })
	                ) : _react2.default.createElement(
	                    'div',
	                    null,
	                    _react2.default.createElement('input', { onChange: function onChange(e) {
	                        ...
	                        value: this.state.input.val, placeholder: this.props.placeholder, autoComplete: 'off', required: true }),
	                    _react2.default.createElement('span', { className: 'input-control clear-btn', onClick: function onClick() {
	                            return _this2.clearVal();
	                        } })
	                )
	            );
	        }
	...
	Input.propTypes = {
	    inputHandle: _react2.default.PropTypes.func.isRequired,
	    name: _react2.default.PropTypes.string,
	    type: _react2.default.PropTypes.string
	};
	exports.default = Input;

	/* REACT HOT LOADER */ }).call(this); } finally { if (true) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = __webpack_require__(241); if (makeExportsHot(module, __webpack_require__(68))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "Input.js" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(4)(module)))

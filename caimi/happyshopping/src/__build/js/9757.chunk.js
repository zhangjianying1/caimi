...
/***/ function(module, exports, __webpack_require__) {
	...
	var ShareLottery = function (_React$Component) {
	    _inherits(ShareLottery, _React$Component);

	    function ShareLottery(props) {
	        _classCallCheck(this, ShareLottery);

	        var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(ShareLottery).call(this, props));
	    ...
	    _createClass(ShareLottery, [{
	        ...
	        value: function render() {
	            ...
	            return _react2.default.createElement(
	                'div',
	                { className: 'share-lottery' },
	                _react2.default.createElement(_Header2.default, { title: '中奖晒单' }),
	                _react2.default.createElement(
	                    'div',
	                    { className: 'body' },
	                    _react2.default.createElement(
	                        ...
	                        _react2.default.createElement(_ShareLotteryList2.default, _extends({}, this.props, { args: this.state.args, showSlider: function showSlider(i, data) {
	...
	exports.default = ShareLottery;

	/* REACT HOT LOADER */ }).call(this); } finally { if (true) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = __webpack_require__(241); if (makeExportsHot(module, __webpack_require__(68))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "ShareLottery.js" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(4)(module)))
